 ...
 mb-8"></div>
          ...
          <div className="lg:pl-12">
            <div className="relative">
              {/* Background Text */}
              <div className="text-[6rem] lg:text-[8rem] leading-none font-semibold text-white/10 select-none">
                The Power
                <br />
                of Learning
              </div>
              ...
              {/* Highlighted Text */}
              <div className="absolute inset-0 text-[6rem] lg:text-[8rem] leading-none font-semibold">
                <div className="relative">
