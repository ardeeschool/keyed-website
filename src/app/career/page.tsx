  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`shadow-[inset_4px_4px_10px_#c8d0e0,inset_-4px_-4px_10px_#ffffff] w-full text-left px-4 sm:px-5 py-4 rounded-2xl text-base transition-all cursor-pointer outline-none ${
          error
      ...
      >
        <span className="pr-8 block truncate">{value || placeholder}</span>
        <ChevronDown
          className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 flex-shrink-0"
  ...
  return (
    <div>
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className={`shadow-[inset_4px_4px_10px_#c8d0e0,inset_-4px_-4px_10px_#ffffff] w-full px-4 sm:px-5 py-4 rounded-2xl text-base text-black placeholder-black/35 outline-none transition-all ${
          error
            ? "ring-2 ring-red-400/50"
            : "focus:ring-2 focus:ring-white/20"
        }`}
...
function ApplicationForm() {
  ...
  function validate() {
    ...
    if (!file) err.file = "Please upload your CV";
      ...
      if (!ext || !allowed.includes(ext))
        ...
        err.file = "File must be under 5MB";
    }
  ...
  if (submitted) {
    return (
      ...
      >
        ...
        <h3 className="font-interTight text-2xl sm:text-3xl font-medium text-primary mb-3">
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      {/* ── Form grid: single col on mobile, 2-col on md+ ── */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
        ...
        <div>
          ...
          <button
            ...
            className={`w-full shadow-[inset_4px_4px_10px_#c8d0e0,inset_-4px_-4px_10px_#ffffff] px-4 sm:px-5 py-4 rounded-2xl text-left text-base transition-all cursor-pointer outline-none ${
              errors.file
                ? "ring-2 ring-red-400/50"
                : "focus:ring-2 focus:ring-white/20"
            }`}
          ...
          >
            {file ? (
              ...
              <span className="flex items-center gap-2 text-black/50">
                <Upload className="w-4 h-4 flex-shrink-0" />
                <span className="text-sm">.pdf, .doc, .docx, .txt (max 5MB)</span>
              </span>
            )}
          </button>
          {errors.file && (
      ...
      <div className="mt-4 sm:mt-5">
        ...
        <textarea
          ...
          className="shadow-[inset_4px_4px_10px_#c8d0e0,inset_-4px_-4px_10px_#ffffff] w-full px-4 sm:px-5 py-4 rounded-2xl text-base text-primary placeholder-black/35 outline-none transition-all focus:ring-2 focus:ring-white/20 resize-none"
          style={{
            background: "rgba(255, 255, 255, 0.06)",
            border: "1px solid rgba(255,255,255,0.1)",
            fontSize: "16px",
      ...
      {apiError && (
        <div className="mt-4 sm:mt-5 px-4 sm:px-5 py-4 rounded-2xl text-sm text-red-500 bg-red-50 border border-red-100">
          {apiError}
        </div>
      )}
      ...
      <motion.button
        ...
        type="submit"
        disabled={submitting}
        className="mt-6 sm:mt-8 w-full py-4 rounded-2xl text-base font-semibold cursor-pointer transition-all disabled:opacity-60 disabled:cursor-not-allowed"
        style={{
          background:
    ...
    <main className="overflow-x-hidden">
      ...
      <section className="bg-white pt-12 sm:pt-20 pb-12 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span
              className="inline-flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-full mb-6 sm:mb-8"
              style={{
          ...
          <motion.h1
            ...
            className="font-interTight text-4xl sm:text-5xl lg:text-7xl font-medium text-[#1a1a1c] leading-[1.1] mb-4 sm:mb-6"
          >
            Career
          </motion.h1>
      ...
      {/* ═══════════════════════════════════════════════
       *  CURRENT OPENINGS (hidden as before)
       * ═══════════════════════════════════════════════ */}
      <section className="bg-[#EDECEC] py-24 px-4 sm:px-6 hidden">
      ...
      >
        ...
        <div className="hidden sm:block absolute inset-0 rounded-2xl overflow-hidden pointer-events-none">
        ...
        <div className="w-full md:max-w-5xl mx-auto relative z-10">
          ...
          >
            <span
              className="inline-flex items-center gap-2 text-sm font-medium px-4 py-2 rounded-full mb-4 sm:mb-6 text-white"
              style={{
                background: "rgba(255,255,255,0.06)",
              }}
            >
            ...
            <h2 className="font-interTight text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-3 sm:mb-4">
              Apply Now
            </h2>
