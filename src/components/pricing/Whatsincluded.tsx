...
const leftFeatures = [
  {
    ...
    desc: "Priority support with dedicated account management",
  },
  {
    Icon: GraduationCap,
    title: "Training & Onboarding",
    desc: "Comprehensive training for staff and leadership",
  },
  {
    Icon: RefreshCcw,
    title: "Regular Updates",
    desc: "Continuous platform improvements and new features",
  },
];
...
const rightFeatures = [
  ...
  },
  {
    Icon: Smartphone,
    title: "Mobile Access",
    desc: "Full platform access on any device",
  },
];
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="font-interTight text-lg font-bold text-[#1a1a1c] mb-2">
        {title}
      </h3>
...
export default function WhatsIncluded() {
  return (
    <>
      ...
      <section className="bg-[#ffffff] py-24 pb-36 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="font-interTight text-5xl lg:text-6xl font-semibold text-[#1a1a1c] leading-tight">
          ...
          >
            {/* ═══ VERTICAL LINE — full height through center ═══ */}
            <div
              className="v-line"
              style={{
                gridColumn: "2",
            ...
            <div className="relative pr-8" style={{ overflow: "visible" }}>
              <FeatureCard
                ...
                title={leftFeatures[0].title}
                desc={leftFeatures[0].desc}
                index={0}
                side="left"
              />
            ...
            <div className="relative pl-8" style={{ overflow: "visible" }}>
              <FeatureCard
                ...
                title={rightFeatures[0].title}
                desc={rightFeatures[0].desc}
                index={0}
                side="right"
              />
            ...
            <div className="relative pr-8" style={{ overflow: "visible" }}>
              <FeatureCard
                ...
                title={leftFeatures[1].title}
                desc={leftFeatures[1].desc}
                index={1}
                side="left"
              />
            ...
            <div className="relative pl-8" style={{ overflow: "visible" }}>
              <FeatureCard
                ...
                title={rightFeatures[1].title}
                desc={rightFeatures[1].desc}
                index={1}
                side="right"
              />
            ...
            <div className="relative pr-8" style={{ overflow: "visible" }}>
              <FeatureCard
                ...
                title={leftFeatures[2].title}
                desc={leftFeatures[2].desc}
                index={2}
                side="left"
              />
            ...
            <div className="relative pl-8" style={{ overflow: "visible" }}>
              <FeatureCard
                Icon={rightFeatures[2].Icon}
                title={rightFeatures[2].title}
                desc={rightFeatures[2].desc}
                index={2}
                side="right"
              />
