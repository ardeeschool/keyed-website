...
export default function PricingHero() {
  return (
    <section className="relative flex items-center overflow-hidden">
      ...
      <div className="relative z-10 px-4 py-12 lg:px-20 lg:py-20 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm border border-gray-200 text-gray-700 px-4 py-2 rounded-full text-xs lg:text-sm font-semibold mb-6 shadow-sm"
            >
            ...
            <motion.h1
              ...
              className="text-3xl md:text-5xl font-medium leading-[1.1] mb-6 font-interTight"
            >
              <span className="text-[#1a1a1c] font-interTight">One Ecosystem.</span>
              <br />
              <span className="text-[#4a4a4c] font-interTight">Every Function Connected.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-md md:text-lg text-[#6b7a8d] leading-relaxed mb-4 max-w-lg"
            >
          ...
          finance, people, and governance — on a single system.
            ...
            >
              <Link
                href="/contact-us"
                className="inline-flex items-center gap-2.5 px-6 py-3 md:px-8 md:py-4 blackbg hover:bg-[#2d2d2f] text-white font-bold rounded-xl transition-all duration-200 hover:-translate-y-1 no-underline text-xs md:text-base"
              >
                Request Walkthrough
                <ArrowRight className="md:w-5 md:h-5 w-4 h-4" strokeWidth={2.5} />
              </Link>
            </motion.div>
