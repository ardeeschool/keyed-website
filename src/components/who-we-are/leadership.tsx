...
const steps = [
  {
    ...
    description:
      "We understand education because we've lived it. Every feature in KeyEd is informed by real educational experience, not market research. Technology serves education, not the other way around.",
  ...
  },
  {
    ...
    description:
      "We're not here to sell software and disappear. We're building long-term relationships with institutions, supporting their growth and evolution as they support their students' growth.",
  ...
  },
  {
    ...
    description:
      "Just as great schools never stop improving, neither do we. We listen to institutional feedback, adapt to changing needs, and continuously enhance KeyEd to serve schools better.",
