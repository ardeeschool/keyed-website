...
export default function Banner() {
  return (
    <section className="relative w-full min-h-[480px] flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-zinc-900 via-neutral-800 to-zinc-900 px-6 py-24">
      ...
      {/* Static heading */}
      <h1 className="relative z-10 text-5xl md:text-6xl lg:text-7xl font-bold text-zinc-300 text-center leading-tight tracking-tight">
        Built From Real
      </h1>
      ...
      <h1
        ...
        style={{
          background: "linear-gradient(90deg, #f97316 0%, #fb923c 40%, #fbbf24 70%, #f97316 100%)",
      ...
      <p className="relative z-10 text-base md:text-lg text-zinc-500 max-w-xl text-center leading-relaxed italic">
        KeyEd wasn't built in a tech lab. It was born from decades of running
        real schools, facing real challenges, and finding real solutions.
      </p>
