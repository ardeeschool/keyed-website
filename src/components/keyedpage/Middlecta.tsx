...
export default function MiddleCta() {
  return (
    // sticky + z-index so the NEXT section slides over this one
      ...
      <section
        className="relative  overflow-hidden py-12 pb-42 flex items-center justify-center max-w-7xl mx-auto mt-[-140px]  z-1 md:rounded-2xl bg-primary-dark"
      >
        {/* Subtle dot texture */}
        ...
        <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
          ...
          >One number that tells the complete story of institutional health.</motion.p>
